...
rm -fr unifrac.tmp
t1=`date +%s`
taskset -c 0-3 time ssu -m unweighted -i unifrac_20000.biom -t unifrac_20000.tre -o unifrac.tmp --mode partial --start 0 --stop 10000
t2=`date +%s`
let dt=t2-t1
rm -fr unifrac.tmp
...
t1=`date +%s`
taskset -c 0-3 time ssu -m unweighted -f -i unifrac_20000.biom -t unifrac_20000.tre -o unifrac.tmp --mode partial --start 0 --stop 10000
t2=`date +%s`
let dt=t2-t1
rm -fr unifrac.tmp
...
rm -fr unifrac.tmp
t1=`date +%s`
taskset -c 0-3 time ssu -m weighted_normalized -i unifrac_20000.biom -t unifrac_20000.tre -o unifrac.tmp --mode partial --start 0 --stop 10000
t2=`date +%s`
let dt=t2-t1
rm -fr unifrac.tmp
...
t1=`date +%s`
taskset -c 0-3 time ssu -m weighted_normalized -f -i unifrac_20000.biom -t unifrac_20000.tre -o unifrac.tmp --mode partial --start 0 --stop 10000
t2=`date +%s`
let dt=t2-t1
rm -fr unifrac.tmp
