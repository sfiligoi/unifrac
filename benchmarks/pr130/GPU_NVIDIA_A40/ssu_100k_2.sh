...
for n in 0 1; do
  ...
  echo "= start ${b} stop ${e}"
  t1=`date +%s`
  taskset -c 8-15 time ssu -m unweighted -i unifrac_${i}0000.biom -t unifrac_${i}0000.tre -o unifrac.tmp --mode partial --start ${b} --stop ${e}
  t2=`date +%s`
  let dt=t2-t1
  ls -l unifrac.tmp
  rm -fr unifrac.tmp
...
for n in 0 1; do
  ...
  echo "= start ${b} stop ${e}"
  t1=`date +%s`
  taskset -c 8-15 time ssu -m unweighted -f -i unifrac_${i}0000.biom -t unifrac_${i}0000.tre -o unifrac.tmp --mode partial --start ${b} --stop ${e}
  t2=`date +%s`
  let dt=t2-t1
  ls -l unifrac.tmp
  rm -fr unifrac.tmp
...
for n in 0 1; do
  ...
  echo "= start ${b} stop ${e}"
  t1=`date +%s`
  taskset -c 8-15 time ssu -m weighted_normalized -i unifrac_${i}0000.biom -t unifrac_${i}0000.tre -o unifrac.tmp --mode partial --start ${b} --stop ${e}
  t2=`date +%s`
  let dt=t2-t1
  ls -l unifrac.tmp
  rm -fr unifrac.tmp
...
for n in 0 1; do
  ...
  echo "= start ${b} stop ${e}"
  t1=`date +%s`
  taskset -c 8-15 time ssu -m weighted_normalized -f -i unifrac_${i}0000.biom -t unifrac_${i}0000.tre -o unifrac.tmp --mode partial --start ${b} --stop ${e}
  t2=`date +%s`
  let dt=t2-t1
  ls -l unifrac.tmp
  rm -fr unifrac.tmp
