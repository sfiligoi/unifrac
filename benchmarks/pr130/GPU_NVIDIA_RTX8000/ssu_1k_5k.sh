...
t1=`date +%s`
taskset -c 0-7 time ssu -m unweighted -i unifrac_${i}000.biom -t unifrac_${i}000.tre -o unifrac.tmp --mode partial --start 0 --stop ${s}
t2=`date +%s`
let dt=t2-t1
ls -l unifrac.tmp
rm -fr unifrac.tmp
echo "=== ${i}000 unweighted time: $dt ==="

t1=`date +%s`
taskset -c 0-7 time ssu -m unweighted -f -i unifrac_${i}000.biom -t unifrac_${i}000.tre -o unifrac.tmp --mode partial --start 0 --stop ${s}
t2=`date +%s`
let dt=t2-t1
ls -l unifrac.tmp
rm -fr unifrac.tmp

echo "=== ${i}000 unweighted -f time: $dt ==="
...
t1=`date +%s`
taskset -c 0-7 time ssu -m weighted_normalized -i unifrac_${i}000.biom -t unifrac_${i}000.tre -o unifrac.tmp --mode partial --start 0 --stop ${s}
t2=`date +%s`
let dt=t2-t1
ls -l unifrac.tmp
rm -fr unifrac.tmp
echo "=== ${i}000 weighted_normalized time: $dt ==="

t1=`date +%s`
taskset -c 0-7 time ssu -m weighted_normalized -f -i unifrac_${i}000.biom -t unifrac_${i}000.tre -o unifrac.tmp --mode partial --start 0 --stop ${s}
t2=`date +%s`
let dt=t2-t1
ls -l unifrac.tmp
rm -fr unifrac.tmp
echo "=== ${i}000 weighted_normalized -f time: $dt ==="
